...
instrumentalAnimation startsAt =
  nonEmptyToCofree (Just (const mempty))
    ( (pos (beats 1.0) /\ wedge0)
        :| ( (pos (beats 1.5) /\ wedge1)
              : (pos (beats 2.5) /\ wedge2)
              : (pos (beats 3.5) /\ wedge3)
              : (pos (beats 4.5) /\ wedge4)
              : (pos (beats 5.5) /\ wedge5)
              : (pos (beats 6.0) /\ wedge6)
              : (pos (beats 7.0) /\ wedge7)
              : (pos (beats 8.0) /\ wedge8)
              : (pos (beats 9.0) /\ wedge9)
              : (pos (beats 9.5) /\ wedge10)
              : (pos (beats 10.5) /\ wedge11)
              : (pos (beats 11.5) /\ wedge12)
              : (pos (beats 12.5) /\ wedge13)
              : Nil
          )
    )
  where
