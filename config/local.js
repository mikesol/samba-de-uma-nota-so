module.exports = {
  ...
  audioBuffersLH: {
    chiffyE1: "http://localhost:8000/chiffyE1.mp3",
    chiffyE5: "http://localhost:8000/chiffyE5.mp3",
    digistensuE5: "http://localhost:8000/digistensuE5.mp3",
    mtDillJabsE4: "http://localhost:8000/mtDillJabsE4.mp3",
    shamisenE5: "http://localhost:8000/shamisenE5.mp3",
    tinefullE2: "http://localhost:8000/tinefullE2.mp3",
    vsMagicE1: "http://localhost:8000/vsMagicE1.mp3",
    vsMagicE5: "http://localhost:8000/vsMagicE5.mp3",
    chiffyE2: "http://localhost:8000/chiffyE2.mp3",
    digistensuE2: "http://localhost:8000/digistensuE2.mp3",
    digistensuE6: "http://localhost:8000/digistensuE6.mp3",
    mtDillJabsE5: "http://localhost:8000/mtDillJabsE5.mp3",
    shamisenE6: "http://localhost:8000/shamisenE6.mp3",
    tinefullE3: "http://localhost:8000/tinefullE3.mp3",
    vsMagicE2: "http://localhost:8000/vsMagicE2.mp3",
    chiffyE3: "http://localhost:8000/chiffyE3.mp3",
    digistensuE3: "http://localhost:8000/digistensuE3.mp3",
    jarbleIctusE3: "http://localhost:8000/jarbleIctusE3.mp3",
    shamisenE3: "http://localhost:8000/shamisenE3.mp3",
    tinefullE0: "http://localhost:8000/tinefullE0.mp3",
    tinefullE4: "http://localhost:8000/tinefullE4.mp3",
    vsMagicE3: "http://localhost:8000/vsMagicE3.mp3",
    chiffyE4: "http://localhost:8000/chiffyE4.mp3",
    digistensuE4: "http://localhost:8000/digistensuE4.mp3",
    mtDillJabsE3: "http://localhost:8000/mtDillJabsE3.mp3",
    shamisenE4: "http://localhost:8000/shamisenE4.mp3",
    tinefullE1: "http://localhost:8000/tinefullE1.mp3",
    tinefullE5: "http://localhost:8000/tinefullE5.mp3",
    vsMagicE4: "http://localhost:8000/vsMagicE4.mp3",
  },
};
